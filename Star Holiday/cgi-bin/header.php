            ...
            <div class="container-fluid ">
                <div class="navbar-header" >
                    ...
                    <a class="navbar-brand" href="index.php" style="margin-top: -19px;margin-left: -26px;">                      
                        <img src="images/star_holiday_logo/111.png"/>
                    </a>
                </div>
                <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        <li class="">
                            <a  id="navbarDropdown" data-toggle="dropdown">Login</a>
                            <ul class="dropdown-menu " aria-labelledby="navbarDropdown">
                                 <li ><a href="" class="dropdown-item" style="hover: color:black">Admin</a></li>
                                 <li><a href="" class="dropdown-item" data-toggle="modal" data-target="#loginFormR">Agent</a></li>
                            </ul>
                        </li>
