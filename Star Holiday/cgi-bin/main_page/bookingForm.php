                        ...
                        <div class="search-tabs search-tabs-bg search-tabs-bottom mb50">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-2">
                                    ...
                                    <div class="tabbable">
                                        <ul class="nav nav-tabs" id="myTab" style="font-size: bold;font-weight: bold;">
                                                ...
                                                <form id="form1" action="" method="post">
                                                    ...
                                                    <div class="tab-content">
                                                        <div class="tab-pane fade" id="tab-2">
                                                                        ...
                                                                        <div class="row">
                                                                            <div class="col-md-3">
                                                                                <div class="form-group form-group-lg form-group-icon-left">
                                                                                    ...
                                                                                    <input class="form-control" type="text" name="checkInDate" id="checkIn" placeholder="DD/MM/YYYY" value="" />
                                                                                </div>
                                                                            </div>
                                                                            <div class="col-md-3">
                                                                                <div class="form-group form-group-lg form-group-icon-left">
                                                            ...
                                                            <button class="btn btn-primary btn-lg" type="button" id="HotelSearch" style="padding-bottom: 30px">
                                                        ...
                                                        <div class="tab-pane fade in active" id="tab-1">
                                                                                    ...
                                                                                    <div class="row">
                                                                                        <div class="col-md-6">
                                                                                            <div class="form-group form-group-lg form-group-icon-left">
                                                                                                ...
                                                                                                <label>
                                                                                                Departing</label>
                                                                                                <input class="form-control" id="departing" name="depDate" type="text" placeholder="DD/MM/YYYY" value="" />
                                                                                            </div>
                                                                                        </div>
                                                                                        <div class="col-md-6">
                                                                                            <div class="form-group form-group-lg form-group-icon-left">
                                                                                                ...
                                                                                                <label>
                                                                                                Returning</label>
                                                                                                <input class="form-control" id="returning" name="returnDate" type="text" placeholder="DD/MM/YYYY" value="" />
                                                            ...
                                                            <button class="btn btn-primary btn-lg" type="button" id="FlightSearch" style="padding-bottom: 30px">
